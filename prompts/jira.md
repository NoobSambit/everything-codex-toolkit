...
- `prompts/plan.md` to create implementation plan
...
- Use `prompts/plan.md` to create an implementation plan from the requirements
- Use the `tdd-workflow` skill to implement with test-driven development
- Use `prompts/code-review.md` after implementation
- Use this prompt's comment workflow to post progress back to the ticket
- Use this prompt's transition workflow to move the ticket when work is complete
