...
1. **Project rules** — Read `AGENTS.md`, project docs, and any contributing guidelines
2. **Planning artifacts** — Check project planning or implementation notes when they exist
...
If the project asks for a saved review artifact, create it under the project's normal docs or review folder:
...
Artifacts:
  Review: <project review artifact path, if one was requested>
  GitHub: <PR URL>
