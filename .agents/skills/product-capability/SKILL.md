...
If useful, point to the next toolkit workflow:
...
HANDOFF
- what should happen next and which toolkit workflow should take it
```
...
- The resulting plan is reusable as a Codex planning artifact.
