...
Use this skill whenever the request depends on accurate, up-to-date behavior of a library, framework, or API. In Codex, use it when Context7 or another documentation MCP is configured.
